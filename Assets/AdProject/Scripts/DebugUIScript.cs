...
public class DebugUIScript : MonoBehaviour
{
	...
	void Start ()
    {
        DebugUIBuilder.instance.AddLabel("ログ");
        Vector3 position = GameObject.FindGameObjectWithTag("Shoes").transform.position;
        DebugUIBuilder.instance.AddLabel("初期位置"+ position.ToString());
