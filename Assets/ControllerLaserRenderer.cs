...
public class ControllerLaserRenderer : MonoBehaviour
{
    ...
    {
        DebugUIBuilder.instance.AddLabel("renderLaserFullLength was called!");
        renderLaser(rightHandAnchor.position, rightHandAnchor.position + ray.direction * maxRayDistance);
    }
